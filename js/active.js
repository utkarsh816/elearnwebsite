...
whatsapp.href = 'https://api.whatsapp.com/send?phone=+916387658129';
document.body.appendChild(whatsapp);

var whatsappText = document.createElement('span');
whatsapp.appendChild(whatsappText);
whatsappText.classList.add('fa');
whatsappText.classList.add('fa-whatsapp');
whatsappText.classList.add('whatsappText')
whatsappText.classList.add('fa-3x');